...
- # Raw Mana
	Raw mana is mana that exists independently, outside of the soul. Raw mana — when it comes into contact with other types of mana — will amplify said manas, which I’ll explain when we get to them.
--- 
# The Mana Triad 
- # Phana
	A play on the words “mana” and “photon”; phana are particles that act the same as photons except for the fact that they expire (decaying into heat). Casting it with no prior control will result in you glowing, given that you’ve enough experience to make phana glow. If you are a significant being you can cast phana in what’s equivalent to gamma rays, high ill-advised if you have no control.
